...
--------------------------------------------------------------
--------------------- CUSTOM ADD PART  -----------------------
-- update attributes from the table osm_city_point to sees names on latin
UPDATE osm_city_point SET name = tags -> 'name:sr-Latn' where tags -> 'name:sr-Latn' is not null;
UPDATE osm_city_point SET name = tags -> 'name:en' where tags -> 'name:sr-Latn' is null;

UPDATE osm_city_point SET tags = tags || hstore('name', tags -> 'name:sr-Latn') where tags -> 'name:sr-Latn' is not null;
UPDATE osm_city_point SET tags = tags || hstore('name', tags -> 'name:en') where tags -> 'name:sr-Latn' is null;

UPDATE osm_city_point SET tags = tags || hstore('name:sr', tags -> 'name:sr-Latn');
